 ...
 * @info: this is the structure containing potential arguments. it is used to maintain
 ...
 * @info: this structure contains potential arguments. it's used to maintain
 *          constant function prototype.
